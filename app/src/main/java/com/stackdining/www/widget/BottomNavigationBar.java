...
public class BottomNavigationBar extends LinearLayout implements View.OnClickListener {
    ...
    private int[] selectIcon = {R.mipmap.frame_check, R.mipmap.member_check, R.mipmap.order_check, R.mipmap.my_check};
    private String[] titles = {"Home","Member","Order","My"};
    ...
    //选中时icon
    private int[] normalIcon = {R.mipmap.frame, R.mipmap.member, R.mipmap.order, R.mipmap.my};

    private int textColor = Color.parseColor("#EAB54A");
    private int unTextColor = Color.parseColor("#9D9D9E");
    ...
    private void init(Context context) {
        ...
        tv_first.setTextColor(textColor);
        tv_second.setTextColor(unTextColor);
        tv_third.setTextColor(unTextColor);
        tv_fourth.setTextColor(unTextColor);
    ...
    private void setUnSelect(int position) {
        switch (position) {
            case 0:
                ...
                tv_first.setVisibility(VISIBLE);
                tv_first.setTextColor(unTextColor);
